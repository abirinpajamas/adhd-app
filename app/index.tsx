    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.topNav}>
          ...
          <TouchableOpacity style={styles.navButton}>
            <Text style={styles.navButtonText}>Question</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.navButton}>
        ...
        />
        <Text style={styles.appName}>MedAssess</Text>
        <Text style={styles.appSubtitle}>Your health screening companion</Text>
